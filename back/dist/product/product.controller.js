...
let ProductController = class ProductController {
    ...
    async getProductsByRestaurantId(restaurantId) {
        return this.productService.findByRestaurantId(restaurantId);
    }
    updateProduct(id, name, price, stock, restaurantId) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ProductController.prototype, "getProductsByRestaurantId", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('name')),
    __param(2, (0, common_1.Body)('price')),
    __param(3, (0, common_1.Body)('stock')),
    __param(4, (0, common_1.Body)('restaurantId')),
    __metadata("design:type", Function),
